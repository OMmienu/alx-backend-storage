...
+ [What is NoSQL ?](https://youtu.be/qUV2j3XBRHc)
+ [MongoDB with Python Crash Course - Tutorial for Beginners](https://youtu.be/E-1xI85Zog8)
...
+ Potential issue if documents creation doesn’t work or this error: `Data directory /data/db not found., terminating` ([source](https://link.medium.com/289vs9aRxBb) and [source](https://stackoverflow.com/questions/37702957/mongodb-data-db-not-found))
...
+ The database name will be passed as option of `mongo` comman
```ruby
